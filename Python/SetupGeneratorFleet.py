...
def addEIA860Data(genFleet,interconn,stoFTLabels,missingStoDuration=4): #statesForAnalysis
    ...
    genFleet = genFleet.merge(storage[['Plant Code','Nameplate Energy Capacity (MWh)','Maximum Charge Rate (MW)','Maximum Discharge Rate (MW)','Technology']],left_on='ORIS Plant Code',right_on='Plant Code',how='left')
